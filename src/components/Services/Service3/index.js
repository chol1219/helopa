...
import Slider1 from "../../../assets/image/service/slider3.png";
import Title1 from "../../../assets/image/service/title3.png";
import Image from "../../../assets/image/service/image3.png";
import VectorImage from "../../../assets/image/service/Vector3.png";
      ...
      <div>
        <div className="w-full relative">
          ...
          <div className="to-blue-3 absolute h-full w-full top-[30%] text-white text-xs flex flex-col px-14 items-center">
            ...
            />
            <p className="text-white text-center text-2xl pt-10 text-bold lg:text-5xl">{t('service_title_3')}</p>
          </div>
