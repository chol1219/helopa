...
import Slider1 from "../../../assets/image/service/slider2.png";
import Title1 from "../../../assets/image/service/title2.png";
import Image from "../../../assets/image/service/image2.png";
import Image2 from "../../../assets/image/service/image2-2.png";
import VectorImage from "../../../assets/image/service/Vector2.png";
      ...
      <div>
        <div className="w-full relative">
          ...
          <div className="to-blue-3 absolute h-full w-full top-[30%] text-white text-xs flex flex-col px-14 items-center">
            ...
            />
            <p className="text-white text-center text-2xl pt-10 text-bold lg:text-5xl">{t('service_title_2')}</p>
          </div>
        ...
        <div className="w-full pt-[53px] lg:pt-[181px] pb-[53px] lg:pb-[181px] flex flex-col items-center">
          <div className="w-full text-blue-1 text-center text-3xl font-bold">
            {t('service_2_second_title')}
          </div>
          <div className="w-full lg:w-5/6 lg: text-blue-5 text-justify lg:text-center text-lg pt-[53px] pb-[53px] lg:pt-[65px] px-10">
            {t('service_2_conclusion')}
          </div>
